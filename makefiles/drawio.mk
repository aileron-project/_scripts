...
drawio-jpg-usage:
	...
	# Exec  : $$(DRAWIO_CMD) --export --format jpg $$(ARGS) $$(DRAWIO_OPTION_JPG) $$^
	# Desc  : Export *.drawio as jpg image.
	# Examples:
	#   - make drawio-jpg
...
drawio-png-usage:
	...
	# Exec  : $$(DRAWIO_CMD) --export --format png $$(ARGS) $$(DRAWIO_OPTION_PNG) $$^
...
drawio-svg-usage:
	...
	# Exec  : $$(DRAWIO_CMD) --export --format svg $$(ARGS) $$(DRAWIO_OPTION_SVG) $$^
...
drawio-pdf-usage:
	...
	# Exec  : $$(DRAWIO_CMD) --export --format pdf $$(ARGS) $$(DRAWIO_OPTION_PDF) $$^
